...
model = baseRegressor(raw_data=df,feature_stop=265,target_column=268,
                      regressor=True, existing_weights=[-0.01,0.01],
                      features_to_use=wt,stoppage=800000);
model.fit(alpha=0.00000000001,target_error=0.00001); # Best I could find for 268
"""
